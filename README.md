...
```javascript
ulpdiff = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-ulp-difference@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-ulp-difference@v0.1.1-umd/browser.js"></script>
```
